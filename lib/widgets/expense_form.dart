...
class ExpenseForm extends StatefulWidget {
  final Expense? expense; // If provided, we're editing; otherwise adding new
...
class _ExpenseFormState extends State<ExpenseForm> {
  ...
  void initState() {
    ...
    // If editing, pre-fill the form with expense data
  ...
  Future<void> _loadCategories() async {
    ...
    try {
      ...
      // Set default selected category if available and not already set
    ...
    if (_formKey.currentState!.validate()) {
      ...
      try {
        ...
        final expense = Expense(
          id: widget.expense?.id, // Include ID if editing
